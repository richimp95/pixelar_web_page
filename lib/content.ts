export const content = {
  ...
  planes: {
    ...
    items: [
      {
        ...
        features: [
          ...
          { name: "Soporte y cambios pequeños", detail: "1 h/mes" },
        ],
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Soporte (contenido/productos)", detail: "2-3 h/mes" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Soporte", detail: "5-10 h/mes" },
          { name: "SEO básico y analítica", detail: "Incluido" },
        ],
    ...
    extraNote:
      "Los desarrollos más pesados o las funcionalidades complejas fuera de las horas de soporte tienen un costo adicional según la magnitud y finalidad del cambio.",
    startSprint: {
      ...
      features: [
        { name: "Sprints ágiles de 2 semanas", detail: "Por fase" },
      ...
      note: "El costo por sprint depende de la dificultad y los requerimientos técnicos.",
